...
FF_CONFIG = {
    ...
    LockedClientConVars = {
        ...
        threateffects_death_capturetime = "30",
        threateffects_death_includeshots = "0",
        threateffects_death_includesess = "1",
        threateffects_death_intensity_shake = "1",
        threateffects_death_intensity_flash = "1",
        threateffects_death_volume_scream = "0.75",
        threateffects_death_volume_background = "0.75",
        threateffects_death_custom = "",
